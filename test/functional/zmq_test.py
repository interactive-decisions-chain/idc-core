...
from test_framework.test_framework import IDCCTestFramework, SkipTest
...
class ZMQTest (IDCCTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that idcc has been built with ZMQ enabled
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("idccd has not been built with zmq enabled.")
