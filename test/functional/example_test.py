...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the IDCCTestFramework
    pass

class ExampleTest(IDCCTestFramework):
    # Each functional test is a subclass of the IDCCTestFramework class.
    ...
    def custom_method(self):
        ...
        IDCCTestFramework class so other tests can use it."""
