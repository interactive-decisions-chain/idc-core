#!/bin/sh
#-###############################################-#
# C++ Cross-Compiler - The IDC-Core Developer-2019 #
#-###############################################-#
...
[ -f "./src/qt/idc-qt.exe" ] && cp "./src/qt/idc-qt.exe" "$RELEASE"
[ -f "./src/idcd.exe" ] && cp "./src/idcd.exe" "$RELEASE"
[ -f "./src/idc-cli.exe" ] && cp "./src/idc-cli.exe" "$RELEASE"
