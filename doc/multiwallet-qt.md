...
In order to support loading of multiple wallets in idcc-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is idcc.cpp.
...
Changes to idcc.cpp
----------------------
idcc.cpp is the entry point into idcc-qt, and as such, will require some minor modifications to provide hooks for
