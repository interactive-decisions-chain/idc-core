...
This mechanism has been integrated into Bitcore-Node-IDCC which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/IDCC-Project/insight-api-idcc#web-socket-api](https://github.com/IDCC-Project/insight-api-idcc#web-socket-api) 
* API: [https://github.com/IDCC-Project/insight-api-idcc#instantx-transactions](https://github.com/IDCC-Project/insight-api-idcc#instantx-transactions)
...
By default, the IDCCcore daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the IDCCcore daemon:
