...
In order to support loading of multiple wallets in idchain-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is idchain.cpp.
...
Changes to idchain.cpp
----------------------
idchain.cpp is the entry point into idchain-qt, and as such, will require some minor modifications to provide hooks for
