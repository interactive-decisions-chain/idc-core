...
This guide describes how to build idccd and command-line utilities on OpenBSD.
...
git clone https://github.com/IDCC-Core/idcc.git
```
...
(see issue [#6658](https://github.com/IDCC-Core/idcc/issues/)).
