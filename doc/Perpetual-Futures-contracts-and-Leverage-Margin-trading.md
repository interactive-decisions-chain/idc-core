...
* Below is a basic example of using leverage, also known as simple leverage.
        ...
        A and B are currently trading IDCC/USD in their locality.
        
        A used the amount of USD 100,000,000 to buy 10 IDCC for USD 10,000,000 / IDCC. The total amount A currently uses is 100,000,000 USD. He only uses his existing capital to do business without using financial leverage, not borrowing more.
        
        B also used the capital of USD 100,000,000 and borrowed more than USD 50,000,000 to buy 15 IDCC for USD 10,000,000 / IDCC. The total amount B currently uses is 150,000,000 USD. Currently, B borrowed more money from his friends, which is B's use of financial leverage. B is controlling 15 IDCC with only USD 100,000,000.
        
        If IDCC is favorable, the total ROE value of B and A increases by 25%, they sell then:
        ...
        * B earns USD 150,000,000 x 0.25 = USD 37,500,000, from it initial capital of USD 100,000,000. Profit of 37.5%.
        ...
        If IDCC is unstable, the total ROE value of B and A decreases by 10%, they sell then:
...
IDCCgate offers leverage on operations with derivatives with the maximum of `x100 leverage`. `Note: high leverage increases trading risks`.

* Masternode Collateral System & Open Position

To open a position, you need to have a sufficient initial margin level which is holding by our `masternode collateral` function. It is a 100% `decentralised collateral system` that IDCCcore specially implemented to serves as collateral for your order. It is calculated in proportion to the leverage you choose. 
...
IDCCgate also has cross margin method. This means that the maintenance margin of your Margin Balance will be shared among all your open positions. Therefore, when a trader has several open positions, the maintenance margin also includes:
...
To record information about opening an order and add information about a completed transaction to the IDCC blockchain, you need to spend a particular amount of TX fee.


* IDCCgate fees, Makers and Takers fees.
        ...
        TX fee is used for all the transaction within the IDCC blockchain system.
