Contributing to IDChain
============================

The IDchain project operates an open contributor model where anyone is
...
The following applies to code changes to the IDChain project, and is not to be
confused with overall IDChain Network Protocol consensus changes.

Whether a pull request is merged into IDChain rests with the project merge
...
Patches that change IDChain consensus rules are considerably more involved than
...
Where a patch set proposes to change the IDChain consensus, it must have been
...
The project leader is the release manager for each IDChain release.
