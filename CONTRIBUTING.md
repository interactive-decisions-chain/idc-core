Contributing to IDC-Core
============================

The IDC-Core project operates an open contributor model where anyone is
...
The following applies to code changes to the IDC-Core project, and is not to be
confused with overall IDC Network Protocol consensus changes.

Whether a pull request is merged into IDC-Core rests with the project merge
...
Patches that change IDC consensus rules are considerably more involved than
...
Where a patch set proposes to change the IDC consensus, it must have been
...
The project leader is the release manager for each IDC-Core release.
