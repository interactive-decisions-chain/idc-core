...
class CObfuScationSigner {
  public:
    /// Is the inputs associated with this public key? (and there is 20000 IDC - checking if valid masternode)
...
class CObfuscationPool {
  ...
  public:
    ...
    /// Get the denominations for a specific amount of idchain.
