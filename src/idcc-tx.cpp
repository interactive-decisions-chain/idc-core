...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("IDCCcore idcc-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  idcc-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded idcc transaction") + "\n" +
                               "  idcc-tx [options] -create [commands]   " + _("Create hex-encoded idcc transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded idcc transaction
