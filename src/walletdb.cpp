...
bool CWalletDB::WriteIDCCNodeConfig(std::string sAlias, const CIDCCNodeConfig& nodeConfig)
{
    nWalletDBUpdateCounter++;
    return Write(std::make_pair(std::string("adrenaline"), sAlias), nodeConfig, true);
}

bool CWalletDB::ReadIDCCNodeConfig(std::string sAlias, CIDCCNodeConfig& nodeConfig)
{
    return Read(std::make_pair(std::string("adrenaline"), sAlias), nodeConfig);
}

bool CWalletDB::EraseIDCCNodeConfig(std::string sAlias)
{
    nWalletDBUpdateCounter++;
