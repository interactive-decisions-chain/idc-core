...
/** Utility functions used by the IDChain Qt UI.
 */
namespace GUIUtil {
...
// Render IDChain addresses in monospace font
...
// Parse "idchain:" URI into recipient object, return true on successful parsing
