...
#include "idcc-installer/src/updatecontroller.h"
#endif
...
#ifdef ENABLE_UPDATER
    QtIDCCUpdater::UpdateController *controller;
#endif
...
private Q_SLOTS:
    ...
    /** Switch to IDCToken page page */
    void gotoIDCTokenPage(bool toAddTokenPage = false);
