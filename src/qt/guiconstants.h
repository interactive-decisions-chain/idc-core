...
/* IDChain GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "IDChain"
#define QAPP_ORG_DOMAIN "id-chain.org"
#define QAPP_APP_NAME_DEFAULT "IDChain-Qt"
#define QAPP_APP_NAME_TESTNET "IDChain-Qt-testnet"
