...
BitcoinGUI::BitcoinGUI(const NetworkStyle* networkStyle, QWidget* parent) : QMainWindow(parent),
    ...
    QString windowTitle = tr("IDChain Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle) {
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a IDChain address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and idchain: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zIDC"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("About IDChain Core"), this);
    aboutAction->setStatusTip(tr("Show information about IDChain Core"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/qt-project.org/qmessagebox/images/qtlogo-64.png"), tr("About Qt"), this);
    aboutQtAction->setStatusTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("Options"), this);
    optionsAction->setStatusTip(tr("Modify configuration options for IDChain"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your IDChain addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("Verify Message"), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified IDChain addresses"));
    ...
    openAction->setStatusTip(tr("Open a IDChain: URI or payment request"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the IDChain Core help message to get a list with possible IDChain command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle) {
    ...
    QString toolTip = tr("IDChain Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count) {
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to IDChain network", "", count));
}
...
void BitcoinGUI::message(const QString& title, const QString& message, unsigned int style, bool* ret) {
    QString strTitle = tr("IDChain Core"); // default title
