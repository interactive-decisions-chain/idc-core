...
TransactionView::TransactionView(QWidget* parent) : QWidget(parent), model(0), transactionProxyModel(0),
    ...
    typeWidget->addItem(tr("Received IDC From zIDC"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change In zIDC"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zIDC));
