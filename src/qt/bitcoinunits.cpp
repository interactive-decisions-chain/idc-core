...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(IDCC);
    unitlist.append(mIDCC);
    unitlist.append(uIDCC);
    return unitlist;
}
...
QString BitcoinUnits::id(int unit)
{
    ...
    case IDCC:
        return QString("idcc");
    case mIDCC:
        return QString("midcc");
    case uIDCC:
        return QString::fromUtf8("uidcc");
    default:
        return QString("???");
    }
}
...
QString BitcoinUnits::name(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        switch (unit) {
        case IDCC:
            return QString("tIDCC");
        case mIDCC:
            return QString("mtIDCC");
        case uIDCC:
            return QString::fromUtf8("μtIDCC");
        default:
            return QString("???");
        }
    }
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case IDCC:
            return QString("IDCC");
        case mIDCC:
            return QString("Milli-IDCC (1 / 1" THIN_SP_UTF8 "000)");
        case uIDCC:
            return QString("Micro-IDCC (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case IDCC:
            return QString("TestIDCCs");
        case mIDCC:
            return QString("Milli-TestIDCC (1 / 1" THIN_SP_UTF8 "000)");
        case uIDCC:
            return QString("Micro-TestIDCC (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
