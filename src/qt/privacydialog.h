...
class PrivacyDialog : public QDialog {
  ...
  public:
    ...
    void setZIdcControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzIDC_clicked();
    void on_pushButtonSpendzIDC_clicked();
    void on_pushButtonZIDCControl_clicked();
