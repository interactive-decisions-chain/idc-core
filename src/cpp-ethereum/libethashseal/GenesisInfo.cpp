...
#include "genesis/idccMainNetwork.cpp"
#include "genesis/idccTestNetwork.cpp"
...
std::string const& dev::eth::genesisInfo(Network _n)
{
	...
	case Network::idccMainNetwork: return c_genesisInfoIDCCMainNetwork;
	case Network::idccTestNetwork: return c_genesisInfoIDCCTestNetwork;
	default:
...
h256 const& dev::eth::genesisStateRoot(Network _n)
{
	...
	case Network::idccMainNetwork: return c_genesisStateRootIDCCMainNetwork;
	case Network::idccTestNetwork: return c_genesisStateRootIDCCTestNetwork;
	default:
		throw std::invalid_argument("Invalid network value");
	}
}
