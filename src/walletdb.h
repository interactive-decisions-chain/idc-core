...
public:
    ...
    bool WriteIDCCNodeConfig(std::string sAlias, const CIDCCNodeConfig& nodeConfig);
    bool ReadIDCCNodeConfig(std::string sAlias, CIDCCNodeConfig& nodeConfig);
    bool EraseIDCCNodeConfig(std::string sAlias);
