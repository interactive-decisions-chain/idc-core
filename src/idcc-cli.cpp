...
static bool AppInitRPC(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help") || mapArgs.count("-version")) {
        std::string strUsage = _("IDCCcore RPC client version") + " " + FormatFullVersion() + "\n";
        if (!mapArgs.count("-version")) {
            strUsage += "\n" + _("Usage:") + "\n" +
                        "  idcc-cli [options] <command> [params]  " + _("Send command to IDCCcore") + "\n" +
                        "  idcc-cli [options] help                " + _("List commands") + "\n" +
                        "  idcc-cli [options] help <command>      " + _("Get help for a command") + "\n";
