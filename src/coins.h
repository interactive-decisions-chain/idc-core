...
/**
    ...
    ****Note - for IDChain we added fCoinStake to the 2nd bit. Keep in mind when reading the following and adjust as needed.
...
class CCoinsViewCache : public CCoinsViewBacked {
  ...
  public:
    ...
    /**
     * Amount of idchain coming in to a transaction
