...
static bool AppInitRawTx(int argc, char* argv[]) {
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("IDChain Core idchain-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  idchain-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded idchain transaction") + "\n" +
                               "  idchain-tx [options] -create [commands]   " + _("Create hex-encoded idchain transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[]) {
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded idchain transaction
