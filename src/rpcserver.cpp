...
UniValue stop(const UniValue& params, bool fHelp) {
    ...
    StartShutdown();
    return "IDChain server stopping";
}
...
static const CRPCCommand vRPCCommands[] = {
    ...
    /* Pivx features */
    {"idchain", "masternode", &masternode, true, true, false},
    {"idchain", "listmasternodes", &listmasternodes, true, true, false},
    {"idchain", "getmasternodecount", &getmasternodecount, true, true, false},
    {"idchain", "masternodeconnect", &masternodeconnect, true, true, false},
    {"idchain", "masternodecurrent", &masternodecurrent, true, true, false},
    {"idchain", "masternodedebug", &masternodedebug, true, true, false},
    {"idchain", "startmasternode", &startmasternode, true, true, false},
    {"idchain", "createmasternodekey", &createmasternodekey, true, true, false},
    {"idchain", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
    {"idchain", "listmasternodeconf", &listmasternodeconf, true, true, false},
    {"idchain", "getmasternodestatus", &getmasternodestatus, true, true, false},
    {"idchain", "getmasternodewinners", &getmasternodewinners, true, true, false},
    {"idchain", "getmasternodescores", &getmasternodescores, true, true, false},
    {"idchain", "mnbudget", &mnbudget, true, true, false},
    {"idchain", "preparebudget", &preparebudget, true, true, false},
    {"idchain", "submitbudget", &submitbudget, true, true, false},
    {"idchain", "mnbudgetvote", &mnbudgetvote, true, true, false},
    {"idchain", "getbudgetvotes", &getbudgetvotes, true, true, false},
    {"idchain", "getnextsuperblock", &getnextsuperblock, true, true, false},
    {"idchain", "getbudgetprojection", &getbudgetprojection, true, true, false},
    {"idchain", "getbudgetinfo", &getbudgetinfo, true, true, false},
    {"idchain", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
    {"idchain", "mnfinalbudget", &mnfinalbudget, true, true, false},
    {"idchain", "checkbudgets", &checkbudgets, true, true, false},
    {"idchain", "mnsync", &mnsync, true, true, false},
    {"idchain", "spork", &spork, true, true, false},
    {"idchain", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
    {"idchain", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
std::string HelpExampleCli(string methodname, string args) {
    return "> idchain-cli " + methodname + " " + args + "\n";
}
