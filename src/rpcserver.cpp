...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* idcc features */
        {"idcc", "masternode", &masternode, true, true, false},
        //{"idcc", "masternodelist", &masternodelist, true, true, false},
        //{"idcc", "mnbudget", &mnbudget, true, true, false},
        //{"idcc", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        //{"idcc", "mnfinalbudget", &mnfinalbudget, true, true, false},
        //{"idcc", "mnsync", &mnsync, true, true, false},
        {"idcc", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        //{"idcc", "darksend", &darksend, false, false, true}, /* not threadSafe because of SendMoney */
...
{
    return "> idcc-cli " + methodname + " " + args + "\n";
}
