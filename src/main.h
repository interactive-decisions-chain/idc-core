...
/////////////////////////////////////////// idcc
#include <idcc/idccstate.h>
#include <idcc/idccDGP.h>
#include <libethereum/ChainParams.h>
#include <libethashseal/Ethash.h>
#include <libethashseal/GenesisInfo.h>
#include <script/standard.h>
#include <idcc/storageresults.h>
///////////////////////////////////////////

extern std::unique_ptr<IDCCState> globalState;
...
using ExtractIDCCTX = std::pair<std::vector<IDCCTransaction>, std::vector<EthTransactionParams>>;
///////////////////////////////////////////
...
#define START_MASTERNODE_PAYMENTS_TESTNET 1557273602 /* 8 May 2019 */
#define START_MASTERNODE_PAYMENTS 1557273601
...
#define WORKING_VERSION "/IDCC Core:1.0.0/"
#endif

static const int64_t DARKSEND_COLLATERAL = (20000*COIN); //20000 IDCC
static const int64_t DARKSEND_FEE = (0.002*COIN); // reward masternode
static const int64_t DARKSEND_POOL_MAX = (1999999.99*COIN);

static const int nIDCCProtocolSwitchHeight = 580000;
...
extern unsigned int dgpMaxBlockSize; // idcc
...
class IDCCTxConverter{

public:

    IDCCTxConverter(CTransaction tx, CCoinsViewCache* v = NULL, const std::vector<CTransaction>* blockTxs = NULL) : txBit(tx), view(v), blockTransactions(blockTxs){}

    bool extractionIDCCTransactions(ExtractIDCCTX& idccTx);
...
private:
    ...
    IDCCTransaction createEthTX(const EthTransactionParams& etp, const uint32_t nOut);
...
public:
    ...
    ByteCodeExec(const CBlock& _block, std::vector<IDCCTransaction> _txs, const uint64_t _blockGasLimit) : txs(_txs), block(_block), blockGasLimit(_blockGasLimit) {}
...
private:
    ...
    std::vector<IDCCTransaction> txs;
