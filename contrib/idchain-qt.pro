...
RESOURCES += src/qt/idchain.qrc src/qt/idchain_locale.qrc

TRANSLATIONS += src/qt/locale/idchain_bg.ts \
                src/qt/locale/idchain_de.ts \
                src/qt/locale/idchain_en.ts \
                src/qt/locale/idchain_es.ts \
                src/qt/locale/idchain_fi.ts \
                src/qt/locale/idchain_fr.ts \
                src/qt/locale/idchain_it.ts \
                src/qt/locale/idchain_ja.ts \
                src/qt/locale/idchain_pl.ts \
                src/qt/locale/idchain_pt.ts \
                src/qt/locale/idchain_ru.ts \
                src/qt/locale/idchain_sk.ts \
                src/qt/locale/idchain_sv.ts \
                src/qt/locale/idchain_vi.ts \
                src/qt/locale/idchain_zh_CN.ts \
                src/qt/locale/idchain_zh_TW.ts
