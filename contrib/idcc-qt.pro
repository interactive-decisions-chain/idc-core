...
RESOURCES += src/qt/idcc.qrc src/qt/idcc_locale.qrc

TRANSLATIONS += src/qt/locale/idcc_bg.ts \
                src/qt/locale/idcc_de.ts \
                src/qt/locale/idcc_en.ts \
                src/qt/locale/idcc_es.ts \
                src/qt/locale/idcc_fi.ts \
                src/qt/locale/idcc_fr.ts \
                src/qt/locale/idcc_it.ts \
                src/qt/locale/idcc_ja.ts \
                src/qt/locale/idcc_pl.ts \
                src/qt/locale/idcc_pt.ts \
                src/qt/locale/idcc_ru.ts \
                src/qt/locale/idcc_sk.ts \
                src/qt/locale/idcc_sv.ts \
                src/qt/locale/idcc_vi.ts \
                src/qt/locale/idcc_zh_CN.ts \
                src/qt/locale/idcc_zh_TW.ts
