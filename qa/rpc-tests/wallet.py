...
#   c) node1 mines 32 blocks, so now node 0 has 60001IDC node 1 has 4250IDC node2 has none.
#   d) node0 sends 601 IDCto node2, in two transactions (301 IDC then 300 IDC.
